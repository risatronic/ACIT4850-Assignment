...
class Portfolio extends Application {
        ...
        function __construct()
	{
        ...
        public function index($player = null)
        {
            ...
            $this->data['portfolio_activity'] = 
                    $this->portfolio_activity($player);
            $this->data['portfolio_holdings'] = 
                    $this->portfolio_holdings($player);
            
            // Render.
            $this->data['content'] = $this->parser->parse('portfolio', 
                    $this->data, true);
            $this->render();
        }
        ...
        private function portfolio_activity($player)
        {
            ...
            return $this->parser->parse('portfolio_activity', $this->data, 
                    true);
        }
        ...
        private function portfolio_holdings($player)
        {
            ...
            return $this->parser->parse('portfolio_holdings', $this->data, 
                    true);
        }
}